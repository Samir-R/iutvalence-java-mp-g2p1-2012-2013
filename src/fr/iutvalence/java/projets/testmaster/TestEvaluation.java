...
public class TestEvaluation {
	...
	public static void main(String[] args) {
		...
		/*
		 * Pion p1 = new Pion(Couleur.BLEU); Pion p2 = new Pion(Couleur.VERT);
		 * Pion p3 = new Pion(Couleur.VERT); Pion p4 = new Pion(Couleur.BLEU);
		 * 
		 * Pion p5 = new Pion(Couleur.ROUGE); Pion p6 = new Pion(Couleur.VERT);
		 * Pion p7 = new Pion(Couleur.BLEU); Pion p8 = new Pion(Couleur.JAUNE);
		 * 
		 ...
		 * //System.out.println(essai); System.out.println(e1.toString()+"\n");
		 * 
		 * 
